...
module.exports.run = async function ({
    ...
    case '-r': {
        ...
        } else return api.sendMessage({body: "Bạn đã có trong cơ sở dữ liệu", attachment: await this.subnautica()}, threadID, messageID);
    }
    case 'shop':
    case '-s': {
        if (!existsSync(pathData)) {
